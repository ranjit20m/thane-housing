...
import { updateUserStart, updateUserSuccess, updateUserFailure, 
        ...
        singOutUserStart, signOutUserFailure, signOutUserSuccess } from "../redux/user/userSlice"; 
...
const Profile = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const res = await fetch('/api/auth/signout'); // Since default method is get
      const data = await res.json();
      if(data.success === false) {
  ...
  const handleShowListings = async () => {
    try {
      ...
      console.log(data);
      setUserListings(data); // if everything ok setUserListings to data
    } catch (error) {
      setShowListingsError(true);
    }
  };
